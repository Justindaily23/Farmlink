...
export const registerFarmerSchema = Joi.object({
  ...
  farm_location: Joi.string().trim().optional(),
});

// Farmer Login schema
export const loginFarmerSchema = Joi.object({
...
// Password reset
export const requestFarmerPasswordResetSchema = Joi.object({
  email: Joi.string()
    .trim()
...
// User clicks link and submits password to be hashed and saved to database
export const resetFarmerPasswordSchema = Joi.object({
